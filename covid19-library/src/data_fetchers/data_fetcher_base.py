...
class DataFetcherBase(ABC):
    @property
    @abc.abstractmethod
    def get_observations_for_region_single(self, region_type: str, region_name:str):
        pass

    def get_regional_metadata_single(self, region_type: str, region_name: str, filepath: str):
    ...
    def get_observations_for_region(self, region_type: str, region_name:str, smooth: bool = True):
        """
    ...
    def get_regional_metadata(self, region_type: str, region_name: str, filepath: str):
        ...
        population = 0
        for region in region_name:
            regional_metadata = self.get_regional_metadata_single(region_type, region, filepath)
